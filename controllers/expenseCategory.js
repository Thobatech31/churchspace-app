...
const { expenseCategorySchema } = require("../middleware/authentication/expensecategory_validation_schema")
...
const createExpenseCategory = async (req, res) => {
    ...
    const user = req.user;
    try {
        await expenseCategorySchema.validateAsync(req.body)
...
const updateExpenseCategory = async (req, res) => {
    ...
    if (!availId) return res.status(400).json({ msg: "Expense Category with Id does not Exists" });
